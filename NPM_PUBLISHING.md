...
بسته `readme-press` در رجیستری عمومی npm ثبت شده و نسخه `0.1.3-beta.2` با تگ `beta` در دسترسه. این نسخه با Trusted Publishing از GitHub Actions وارد محیط بازبینی npm شد و بعد از بررسی دستی با تأیید دومرحله‌ای منتشر شد.

نسخه بعدی `0.1.3` است. همون مسیر امن و آزمایش‌شده برای انتشار پایدار استفاده می‌شه: PR، QA کامل، مرحله‌بندی با OIDC، بازبینی artifact و تأیید نهایی با 2FA.
